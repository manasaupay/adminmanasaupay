...
export const ADMIN_TABLES: Record<AdminTableKey, AdminTableConfig> = {
  users: {
    ...
    description:
      "Manage users, roles, verification, blocking, and activity metadata.",
    sectionKey: "users",
    columns: [
      { key: "name", label: "Name" },
  ...
  businesses: {
    ...
    description:
      "Approve businesses, manage premium pages, badges, categories, banners, and sponsorship state.",
    ...
    columns: [
      ...
      { key: "owner_id", label: "Owner", optionSource: "users" },
      {
        key: "category",
        label: "Category",
        optionSource: "businessCategoryLabels",
      },
      {
        key: "subcategory",
        label: "Subcategory",
        optionSource: "businessSubcategoryLabels",
      },
      { key: "phone", label: "Phone" },
      ...
      { key: "is_verified", label: "Verified", type: "boolean" },
      { key: "meta.verified_start", label: "Verified Start Date", type: "date" },
      { key: "meta.verified_end", label: "Verified End Date", type: "date" },
      { key: "is_sponsored", label: "Sponsored", type: "boolean" },
      { key: "meta.sponsored_start", label: "Sponsored Start Date", type: "date" },
      { key: "meta.sponsored_end", label: "Sponsored End Date", type: "date" },
      { key: "meta.featured_start", label: "Featured Start Date", type: "date" },
      { key: "meta.featured_end", label: "Featured End Date", type: "date" },
  ...
  services: {
    ...
    description:
      "Approve providers, assign categories/subcategories, and manage sponsored service listings.",
    sectionKey: "services",
    approveField: "is_approved",
    featuredField: "is_featured",
    columns: [
      ...
      { key: "provider_id", label: "Provider", optionSource: "users" },
      {
        key: "category",
        label: "Category",
        optionSource: "serviceCategoryLabels",
      },
      {
        key: "subcategory",
        label: "Subcategory",
        optionSource: "serviceSubcategoryLabels",
      },
  ...
  auto_drivers: {
    ...
    title: "Auto Booking",
    description:
      "Approve driver profiles and manage availability, areas, call, WhatsApp, and share metadata.",
  ...
  jobs: {
    ...
    description:
      "Approve posts, link businesses, manage applications and sponsored job visibility.",
    sectionKey: "jobs",
    approveField: "is_approved",
    featuredField: "is_featured",
    columns: [
  ...
  categories: {
    ...
    description:
      "Create nested categories and subcategories with icons, colors, banners, ordering, and visibility.",
  ...
  ads: {
    ...
    description:
      "Manage slider, inline, sponsored card, featured shop, and search-result ad placements.",
    sectionKey: "ads",
    activeField: "active",
    columns: [
      {
  ...
  sponsored_shops: {
    ...
    description:
      "Approve sponsorships and control homepage, category, search, and offer placements.",
    ...
    columns: [
      { key: "business_id", label: "Business", optionSource: "businesses" },
      {
        key: "placement",
        label: "Placement",
        options: ["homepage", "category", "search", "offers", "carousel"],
        type: "enum",
      },
      {
        key: "category_key",
  ...
  notifications: {
    ...
    title: "Notifications",
    description:
      "Create broadcast, personalized, category-based, and automated FCM notifications with deep links.",
  ...
  updates: {
    ...
    title: "City Updates",
    description:
      "Publish card-based city notices, announcements, alerts, and community updates.",
    sectionKey: "updates",
    featuredField: "is_featured",
    columns: [
      { key: "title", label: "Title" },
  ...
  news: {
    ...
    description:
      "Add, schedule, publish, and trend local news and announcements.",
    sectionKey: "news",
    activeField: "active",
    featuredField: "is_featured",
    columns: [
  ...
  events: {
    ...
    description:
      "Create event cards with banners, schedules, organizer details, and promotions.",
    sectionKey: "events",
    activeField: "active",
    featuredField: "is_featured",
    columns: [
  ...
  offers: {
    ...
    description:
      "Manage business offers, discount banners, sponsored promotions, and expiry dates.",
    sectionKey: "offers",
    activeField: "active",
    featuredField: "is_featured",
    columns: [
  ...
  properties: {
    ...
    description:
      "Approve listings, manage pricing, images, location metadata, and featured placement.",
    ...
    columns: [
      ...
      { key: "user_id", label: "User", optionSource: "users" },
      {
        key: "property_type",
        label: "Type",
        options: ["residential", "commercial", "plot", "rental"],
        type: "enum",
      },
  ...
  resale: {
    ...
    description:
      "Approve resale items, remove spam, and manage sponsored resale placements.",
    sectionKey: "resale",
    approveField: "is_approved",
    featuredField: "is_featured",
    columns: [
  ...
  reviews: {
    ...
    description:
      "Moderate star ratings, written reviews, images, reports, replies, and verified reviewer state.",
    sectionKey: "reviews",
    activeField: "active",
    columns: [
      {
        key: "target_type",
        label: "Target",
        options: ["business", "service", "property", "resale", "auto"],
        type: "enum",
      },
  ...
  analytics: {
    ...
    description:
      "Track ad clicks, notification clicks, top searches, sponsorship performance, and module activity.",
  ...
  call_sessions: {
    ...
    title: "In-app Calls",
    description:
      "Track Manasa Upay call requests, ringing state, accepted calls, missed calls, and partner response.",
    sectionKey: "calls",
    columns: [
  ...
  settings: {
    ...
    description:
      "Manage app-wide settings for branding, UI, ads, notifications, features, and security.",
    sectionKey: "settings",
    activeField: "active",
    columns: [
      { key: "key", label: "Key" },
      {
        key: "setting_type",
        label: "Value Type",
        options: ["string", "boolean", "number", "json", "url", "color"],
        type: "enum",
      },
      {
        key: "group_name",
  ...
  products: {
    ...
    description:
      "Manage products for businesses, categories, pricing, images, and active listings.",
    sectionKey: "businesses",
    activeField: "active",
    columns: [
